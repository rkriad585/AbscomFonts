...
- Typo in color name: `abs-red-500` ok, `abs-reid-500` wrong
- Typo in shade number: `abs-red-500` ok, `abs-red-50` ok, `abs-red-1000` wrong
- Using `bg-` prefix for icon color: use `bg-red-500` for backgrounds, `abs-red-500` for icon color

## Console Validation Warnings

See [Validation System](./validation) for details on warnings.

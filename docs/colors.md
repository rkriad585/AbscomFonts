...
AbscomFonts includes a Tailwind-inspired color palette with 25 colors and 11 shades each (50–950), plus gradient, inverse, and opacity utilities.
...
<i class="abs abs-star abs-gradient abs-gradient-from-blue-500 abs-gradient-to-purple-500"></i>
```
